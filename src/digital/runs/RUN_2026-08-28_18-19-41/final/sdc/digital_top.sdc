...
set_input_delay 6666.0000 -clock [get_clocks {clk}] -add_delay [get_ports {sda_in}]
...
set_output_delay 6666.0000 -clock [get_clocks {clk}] -add_delay [get_ports {sda_oe}]
set_output_delay 6666.0000 -clock [get_clocks {clk}] -add_delay [get_ports {sda_out}]
set_output_delay 6666.0000 -clock [get_clocks {clk}] -add_delay [get_ports {trigger_out}]
###############################################################################
# Environment
###############################################################################
set_load -pin_load 0.0729 [get_ports {sda_oe}]
set_load -pin_load 0.0729 [get_ports {sda_out}]
...
set_driving_cell -lib_cell gf180mcu_fd_sc_mcu7t5v0__inv_1 -pin {ZN} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {sda_in}]
###############################################################################
# Design Rules
###############################################################################
