...
N 770 -280 770 -180 {lab=#net4}
N 680 -230 770 -230 {lab=#net4}
N 690 -450 690 -410 {lab=#net1}
N 660 -450 690 -450 {lab=#net1}
N 660 -580 660 -450 {lab=#net1}
N 750 -480 750 -410 {lab=#net3}
N 720 -480 750 -480 {lab=#net3}
N 720 -580 720 -480 {lab=#net3}
N 720 -370 720 -310 {lab=VDD}
N 460 -500 460 -230 {lab=#net1}
N 460 -500 660 -500 {lab=#net1}
N 720 -510 1060 -510 {lab=#net3}
N 1060 -510 1060 -230 {lab=#net3}
N 960 -230 1060 -230 {lab=#net3}
...
spiceprefix=X
m=10}
C {AURA-Event-Driven-Mixed-Signal-ASIC-for-Acoustic-Pattern-Detection/analog/schmitt_trigger.sym} 570 -230 0 0 {name=x1}
