...
N 680 -230 740 -230 {lab=#net3}
N 780 -200 780 -180 {lab=#net4}
...
N 730 -30 730 -0 {lab=#net5}
N 730 -30 830 -30 {lab=#net5}
N 940 -220 940 -110 {lab=#net5}
N 980 -70 980 -30 {lab=GND}
N 980 -110 980 -80 {lab=GND}
N 980 -110 980 -70 {lab=GND}
N 980 -190 980 -180 {lab=#net2}
N 980 -310 980 -250 {lab=VDD}
N 980 -180 980 -170 {lab=#net2}
N 980 -170 980 -140 {lab=#net2}
N 980 -30 980 120 {lab=GND}
N 980 -240 980 -220 {lab=VDD}
N 980 -250 980 -220 {lab=VDD}
N 780 30 830 30 {lab=#net3}
N 830 -30 870 -30 {lab=#net5}
N 780 -120 780 -30 {lab=#net5}
N 750 30 780 30 {lab=#net3}
N 780 -180 780 -150 {lab=#net4}
N 690 -230 690 -80 {lab=#net3}
N 690 -30 690 30 {lab=en}
N 690 -30 710 -30 {lab=en}
N 710 -150 710 -30 {lab=en}
N 710 -150 740 -150 {lab=en}
N 750 -80 750 30 {lab=#net3}
N 690 -80 750 -80 {lab=#net3}
N 910 -170 920 -170 {lab=#net5}
N 1130 -220 1130 -110 {lab=#net2}
...
N 1060 -170 1130 -170 {lab=#net2}
N 1010 -170 1060 -170 {lab=#net2}
N 870 -170 870 -60 {lab=#net5}
N 870 -170 910 -170 {lab=#net5}
N 980 -170 1010 -170 {lab=#net2}
N 920 -170 940 -170 {lab=#net5}
N 1060 -510 1060 -170 {lab=#net2}
...
C {B04_schmitt_trigger.sym} 550 -230 0 0 {name=x1}
