...
for metal in do_layers
  ...
  # DM.3
  tp.var("space_to_Metal", 1.0 / $ly.dbu)
  
  # DM.4_DM.6
  tp.var("space_to_subsequent_Metal", 1.0 / $ly.dbu)
  
  # DM.5_DM.7
  tp.var("space_to_previous_Metal", 1.0 / $ly.dbu)
  ...
  tp.var("space_to_scribe_line", 3 / $ly.dbu)
