...
C {AURA-Event-Driven-Mixed-Signal-ASIC-for-Acoustic-Pattern-Detection/analog/BPF_2_order.sym} 0 0 0 0 {name=x1}
...
C {code_shown.sym} -540 -280 0 0 {name=include1 only_toplevel=false value=".include /foss/pdks/ciel/gf180mcu/versions/7b70722e33c03fcb5dabcf4d479fb0822d9251c9/gf180mcuD/libs.tech/ngspice/design.ngspice
...
C {code_shown.sym} 230 -80 0 0 {name=s1 only_toplevel=false value="
.control
op
ac dec 100 10 1meg
plot db(vout) 
