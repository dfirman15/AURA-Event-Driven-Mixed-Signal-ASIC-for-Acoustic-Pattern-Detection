...
N 530 -780 610 -780 {lab=#net2}
N 530 -820 530 -780 {lab=#net2}
N 380 -780 530 -780 {lab=#net2}
N 380 -790 380 -780 {lab=#net2}
...
N 710 -620 710 -330 {lab=#net3}
N 730 -620 730 -330 {lab=#net4}
N 750 -620 750 -330 {lab=#net5}
N 770 -620 770 -330 {lab=#net6}
N 890 -610 950 -610 {lab=Vout}
N 690 -610 830 -610 {lab=GND}
N 570 -710 630 -710 {lab=#net1}
N 610 -780 650 -780 {lab=#net2}
N 650 -780 660 -780 {lab=#net2}
N 630 -710 660 -710 {lab=#net1}
N 490 -260 510 -260 {lab=VbiasP}
N 490 -240 510 -240 {lab=VbiasN}
N 380 -940 380 -910 {lab=VDD/2}
N 380 -850 380 -820 {lab=#net2}
N 340 -880 380 -880 {lab=#net7}
N 340 -910 340 -880 {lab=#net7}
N 340 -880 340 -850 {lab=#net7}
N 900 -410 930 -410 {lab=Vout}
N 810 -410 840 -410 {lab=#net1}
N 870 -450 870 -410 {lab=#net8}
N 870 -450 900 -450 {lab=#net8}
N 840 -450 870 -450 {lab=#net8}
...
C {ipin.sym} 490 -260 0 0 {name=p6 lab=VbiasP}
...
C {ipin.sym} 490 -240 0 0 {name=p7 lab=VbiasN}
...
C {symbols/pfet_03v3.sym} 360 -910 0 0 {name=M1
L=4u
W=1u
nf=1
m=1
...
C {symbols/pfet_03v3.sym} 360 -850 2 1 {name=M2
L=4u
W=1u
nf=1
m=1
...
C {symbols/pfet_03v3.sym} 900 -430 1 0 {name=M3
L=4u
W=1u
nf=1
m=1
...
C {symbols/pfet_03v3.sym} 840 -430 3 1 {name=M4
L=4u
W=1u
nf=1
m=1
...
C {symbols/cap_mim_2f0fF.sym} 300 -780 1 1 {name=C1
W=10u
L=10u
model=cap_mim_2f0fF
spiceprefix=X
m=10}
C {symbols/cap_mim_2f0fF.sym} 300 -710 3 1 {name=C2
W=10u
L=10u
model=cap_mim_2f0fF
spiceprefix=X
m=10}
C {symbols/cap_mim_2f0fF.sym} 530 -850 2 1 {name=C3
W=10u
L=10u
model=cap_mim_2f0fF
spiceprefix=X
m=1}
C {symbols/cap_mim_2f0fF.sym} 860 -560 3 1 {name=C4
W=10u
L=10u
model=cap_mim_2f0fF
spiceprefix=X
m=1}
C {symbols/cap_mim_2f0fF.sym} 850 -610 1 1 {name=C5
W=10u
L=10u
model=cap_mim_2f0fF
spiceprefix=X
