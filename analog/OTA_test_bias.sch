...
C {isource.sym} 210 -430 0 0 {name=I0 value=100n}
C {lab_pin.sym} 410 -340 0 0 {name=p1 sig_type=std_logic lab=vdd text_size_0=0.1}
C {isource.sym} 520 -120 0 0 {name=I1 value=100n}
