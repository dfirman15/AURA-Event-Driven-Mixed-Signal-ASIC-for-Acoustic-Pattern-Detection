module B04_A_padring (
  ...
  gf180mcu_fd_io__asig_5p0 W14 (.ASIG5V(W14), .VSS(W12), .DVSS(W12), .VDD(W13), .DVDD(W13));
  assign W15_ASIG5V = W15;
  gf180mcu_fd_io__asig_5p0 W15 (.ASIG5V(W15), .VSS(W12), .DVSS(W12), .VDD(W13), .DVDD(W13));
  assign W16_ASIG5V = W16;
  gf180mcu_fd_io__asig_5p0 W16 (.ASIG5V(W16), .VSS(W12), .DVSS(W12), .VDD(W13), .DVDD(W13));
  assign W17_ASIG5V = W17;
  gf180mcu_fd_io__asig_5p0 W17 (.ASIG5V(W17), .VSS(W12), .DVSS(W12), .VDD(W13), .DVDD(W13));
  ...
  gf180mcu_fd_io__in_s W20 (.PU(W20_PU), .PD(W20_PD), .Y(W20_Y), .PAD(W20), .VSS(W12), .DVSS(W12), .VDD(W13), .DVDD(W13));
  gf180mcu_fd_io__in_c W21 (.PU(W21_PU), .PD(W21_PD), .Y(W21_Y), .PAD(W21), .VSS(W12), .DVSS(W12), .VDD(W13), .DVDD(W13));
  ...
  gf180mcu_fd_io__brk5 BRK_W21_1 (.VSS(W12));
  gf180mcu_fd_io__brk5 BRK_W21_2 (.VSS(W12));
  gf180mcu_fd_io__brk5 BRK_W21_3 (.VSS(W12));
  gf180mcu_fd_io__brk5 BRK_W21_4 (.VSS(W12));
  gf180mcu_fd_io__brk5 BRK_W21_5 (.VSS(W12));
